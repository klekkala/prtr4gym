...
for game in dir_list:
    ...
    np.save(pathname + game + '/5/50/limit_truncated', all_limit[0])
    np.save(pathname + game + '/5/50/episode_truncated', all_epi[0])
    np.save(pathname + game + '/5/50/id_dict_truncated', all_id[0])
    #data1 = data1[data1!=0.0]
    #data10 = np.concatenate(all_val[1], axis=0)
    
    #np.save('../all_1chan_all/' + game + '/5/10/limit', all_limit[1])
    #np.save('../all_1chan_all/' + game + '/5/10/episode', all_epi[1])
    #np.save('../all_1chan_all/' + game + '/5/10/id_dict', all_id[1])
    #data10 = data10[data10!=0.0]
    #data50 = np.concatenate(all_val[2], axis=0)
    #np.save('../all_1chan_all/' + game + '/5/50/limit', all_limit[2])
    #np.save('../all_1chan_all/' + game + '/5/50/episode', all_epi[2])
    #np.save('../all_1chan_all/' + game + '/5/50/id_dict', all_id[2])
    #data50 = data50[data50!=0.0]
    continue
