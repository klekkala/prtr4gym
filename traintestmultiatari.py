...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--log", type=str, default="/lab/kiran/logs/rllib/traintestmultitask", help="config file for resources"
    )
    parser.add_argument(
    ...
    class MultiTaskEnv(gym.Env): 
        def __init__(self, env_config):
            for i in range(len(envs)):    
                if env_config.worker_index%6==i:
    ...
    if args.model=='fcnet':
        ...
        "num_workers": args.num_workers-(args.num_workers%6),
