...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--log", type=str, default="/lab/kiran/logs/rllib/TMPtraintestmultitask", help="config file for resources"
    )
    parser.add_argument(
        "--stop_timesteps", type=int, default=10000, help="Number of timesteps to train."
    )
    parser.add_argument(
    ...
    envs = ["AirRaidNoFrameskip-v4","AssaultNoFrameskip-v4","BeamRiderNoFrameskip-v4","DemonAttackNoFrameskip-v4","RiverraidNoFrameskip-v4","SpaceInvadersNoFrameskip-v4"]
    ...
    if args.model=='fcnet':
        ...
        "num_workers":1# args.num_workers-(args.num_workers%6),
    ...
    if args.tune == False:
        ...
        for _ in range(args.stop_timesteps):
            ...
            if result["timesteps_total"] >= args.stop_timesteps:
                ...
                policy.export_checkpoint("./testatari/atari_checkpoint")
                break
        algo.stop()
    else:
